...
class EditTellUsAboutScreen extends StatefulWidget {
  ...
  const EditTellUsAboutScreen(
      {super.key, required this.about, required this.id});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SimpleTextField(
                            ...
                            hintText:
                                context.loc.hintWriteAFewWordsAboutYourself,
                            maxLine: 7,
                          ...
                          Consumer<EditTellUsAboutScreenProvider>(builder:
                              (context, editTellUsAboutScreenProvider, child) {
                            return CustomButtonTopToBottomColor(
                              width: MediaQuery.of(context).size.width,
                              buttonText: context.loc.buttonUpdate,
                              onTap: () {
                                if (_formKey.currentState!.validate()) {
                                  Common.showLoadingDialog(context);
                                  editTellUsAboutScreenProvider
