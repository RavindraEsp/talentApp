                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SimpleTextField(
                                ...
                                validator: Validators(context).validatorName,
                              ),
                              SizedBox(
                                height: 25.h,
                              ),
                              SimpleTextField(
                                ...
                                onPrefixIconTap: () {
                                  ...
                                  if (passwordObscure == true) {
                                    passPrefixImage = ImageUtility.eyeOpenIcon;
                                  } else {
                                    passPrefixImage = ImageUtility.eyeCloseIcon;
                                  }
                                  provider.updateUi();
                                },
                              ),
                              ...
                              SimpleTextField(
                                ...
                                onPrefixIconTap: () {
                                  confPasswordObscure = !confPasswordObscure;
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    if (phoneController.text.length < 6) {
                                      Common.showErrorSnackBar(
                                          context, context.loc.validationPhone);
                                    } else {
                                      CommonMethod.hideKeyBoard(context);
