...
//   Data? data;
//
//   TalentDataResponseModelNew({this.success, this.message, this.data});
//
...
//   List<Body>? body;
//
//   Data({this.lookingFor, this.body});
//
...
//   bool isSelect = false;
//
//   BodyData({this.id, this.talentId, this.name, this.datetime, this.talentName,required this.isSelect});
//
