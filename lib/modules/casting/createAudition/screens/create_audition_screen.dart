                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              children: [
                                for (var item in createAuditionProvider.lookingForModel!)
                                  LookingForWidget(
                                      onTap: () {
                            ...
                            Row(
                              children: [
                                YesNoCheckBoxWidget(
                                    ...
                                    status: createAuditionProvider.isExperienceNeeded == true,
                                    onTap: () {
                                      createAuditionProvider.isExperienceNeeded = true;
                                      createAuditionProvider.updateUi();
                                    }),
                                SizedBox(
                                  width: 38.h,
                                ...
                                YesNoCheckBoxWidget(
                                    ...
                                    status: createAuditionProvider.isExperienceNeeded == false,
                                    onTap: () {
                                      createAuditionProvider.isExperienceNeeded = false;
                                      createAuditionProvider.updateUi();
                                    }),
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                YesNoCheckBoxWidget(
                                    title: context.loc.checkBoxYes,
                                    status: createAuditionProvider.isTrainingNeeded == true,
                                    onTap: () {
                                      createAuditionProvider.isTrainingNeeded = true;
                                      createAuditionProvider.updateUi();
                                    }),
                                SizedBox(
                                  width: 38.h,
                                ...
                                YesNoCheckBoxWidget(
                                    title: context.loc.checkBoxNo,
                                    status: createAuditionProvider.isTrainingNeeded == false,
                                    onTap: () {
                                      createAuditionProvider.isTrainingNeeded = false;
                                      createAuditionProvider.updateUi();
                                    }),
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                YesNoCheckBoxWidget(
                                    title: context.loc.checkBoxYes,
                                    status: createAuditionProvider.isRepresented == true,
                                    onTap: () {
                                      createAuditionProvider.isRepresented = true;
                                      createAuditionProvider.updateUi();
                                    }),
                                SizedBox(
                                  width: 38.h,
                                ...
                                YesNoCheckBoxWidget(
                                    title: context.loc.checkBoxNo,
                                    status: createAuditionProvider.isRepresented == false,
                                    onTap: () {
                                      createAuditionProvider.isRepresented = false;
                                      createAuditionProvider.updateUi();
                                    }),
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  behavior: HitTestBehavior.opaque,
                                  onTap: () {
                                    for (var item in createAuditionProvider.eyeColorModel!) {
                                      item.isSelect = true;
                                      createAuditionProvider.updateUi();
                                    }
                                  },
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  behavior: HitTestBehavior.opaque,
                                  onTap: () {
                                    for (var item in createAuditionProvider.hairColorModel!) {
                                      item.isSelect = true;
                                      createAuditionProvider.updateUi();
                                    }
                                  },
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  behavior: HitTestBehavior.opaque,
                                  onTap: () {
                                    for (var item in createAuditionProvider.painsSizeModel!) {
                                      item.isSelect = true;
                                      createAuditionProvider.updateUi();
                                    }
                                  },
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  behavior: HitTestBehavior.opaque,
                                  onTap: () {
                                    for (var item in createAuditionProvider.shirtSizeModel!) {
                                      item.isSelect = true;
                                      createAuditionProvider.updateUi();
                                    }
                                  },
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  behavior: HitTestBehavior.opaque,
                                  onTap: () {
                                    for (var item in createAuditionProvider.shoeSizeModel!) {
                                      item.isSelect = true;
                                      createAuditionProvider.updateUi();
                                    }
                                  },
