...
class ApiEndPoints {
  ...
  String get getdynamictalentData => "get/getdynamictalentData";
  ...
  String get getAuditionDetailByIdnew => "auth/getAuditionDetailByIdnew";

  String get cancelAudition => "auth/cancelAudition";
  String get closeRegistration => "auth/closeRegistration";
 ...
 // String get  getEditTalentBody => "get/getEditTalentBody";
  ...
  String get  getEducationContent => "auth/getEducationContent";
